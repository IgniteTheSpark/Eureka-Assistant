...
class _AppShellState extends State<AppShell>
  ...
  void initState() {
    ...
    // backgrounded (another device, a background flash capture, a push). A
    // broad refresh on resume keeps legacy lists current without invalidating
    // the Theme V2 Library cache.
