...
class StreamingAsrSession:
    ...
    def __init__(
        ...
        *,
        ...
        provider_send_timeout_seconds: float,
        ...
        self._provider_send_timeout_seconds = provider_send_timeout_seconds
            ...
            if isinstance(frame, bytes):
                try:
                    ...
                    await asyncio.wait_for(
                        self._provider.send_audio(frame),
                        timeout=self._provider_send_timeout_seconds,
                    )
                except ValueError:
                    await self._send_error("unsupported_audio")
                    return
