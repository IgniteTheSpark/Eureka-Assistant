...
class ReportGenerationRun(Base):
    ...
    scope_adapter: Mapped[str | None] = mapped_column(String(32))
    scope_draft: Mapped[dict | None] = mapped_column(mysql.JSON)
    scope_revision: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    scope_hash: Mapped[str | None] = mapped_column(CHAR(64))
    plan_scope_hash: Mapped[str | None] = mapped_column(CHAR(64))
