...
async def tool_create_note(
    ...
    return await _run(
        "tool_create_note",
        {"content": content, "title": title, "tags": tags, "domain": domain},
        user_id=user_id,
        session_id=session_id,
        source_input_turn_id=source_input_turn_id,
        tool_call_id=tool_call_id,
...
async def tool_update_contact(
    ...
    """Update one Contact field; notes append and supported socials merge."""
    return await _run(
        "tool_update_contact",
        {"contact_id": contact_id, "field": field, "value": value},
        user_id=user_id,
        session_id=session_id,
        source_input_turn_id=source_input_turn_id,
        tool_call_id=tool_call_id,
